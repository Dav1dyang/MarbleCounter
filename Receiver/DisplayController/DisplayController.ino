 ...
 * Display Controller
 *
 * Uses Xiao ESP32-S3 with SevSeg library to control 7-segment display
 * Receives marble count via ESP-NOW and displays on 7-segment display
...
void setup()
{
    ...
    Serial.println("Display Controller - Initializing...");
    ...
    Serial.println("Ready to receive marble counts");
}
